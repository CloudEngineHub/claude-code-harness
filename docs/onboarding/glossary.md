...
| **approve** | "Yes, this matches what I asked for, go ahead." | 「頼んだ内容と合っている。進めてOK」の合図。 |
...
| `Spec delta` | "This task changes the product promise" — read it before approving. | 「このタスクは約束ごと自体を変える」という注記。承認前に読むと安心。 |
...
| **confidence %** | How sure Harness is. Rough guide: 75%+ usually fine to proceed, 40–74% proceed with caution, under 40% pause and ask. | Harness の自信度。目安: 75%以上=だいたい進めてOK、40〜74%=注意して進む、40%未満=いったん止めて相談。 |
...
| **mirror** | Copies of the skills for other tools (Codex / opencode). Internal housekeeping. | 他ツール (Codex / opencode) 向けのスキル複製。内部の整合管理。 |

...
var askQuestionCanonicalValues = map[string]string{
	...
	"single":     "solo",
	"individual": "solo",
	localizedHarnessMessage("ja", "individual", "個人"): "solo",
	localizedHarnessMessage("ja", "solo", "単独"):       "solo",
	"team":         "team",
	"issue":        "team",
	"github issue": "team",
	"github-issue": "team",
	"github_issue": "team",
	localizedHarnessMessage("ja", "team", "チーム"): "team",
	"exploratory":         "exploratory",
	"browser exploratory": "exploratory",
	"explore":             "exploratory",
	localizedHarnessMessage("ja", "explore", "探索"):           "exploratory",
	localizedHarnessMessage("ja", "try in browser", "触って確認"): "exploratory",
	"scripted":         "scripted",
	"browser scripted": "scripted",
	"playwright":       "scripted",
	localizedHarnessMessage("ja", "scripted", "手順固定"): "scripted",
	"patch": "patch",
	"minor": "minor",
	"major": "major",
}

...
- `agent-browser` は Phase 91.7 で「曖昧」と一時判定されたが、Phase 104.9 の参照監査で `skills/harness-work`、`scripts/browser-review-runner.sh`、`scripts/pretooluse-browser-guide.sh`、`scripts/ci/check-consistency.sh` から実配線されていることを確認し保持と裁定（2026-07-05）。gogcli-ops / cc-cursor-cc / cc-update-review は参照ゼロで削除済み。

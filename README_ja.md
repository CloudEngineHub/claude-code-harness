...
| 非エンジニア / 専門用語が不安 | [やさしい用語集](docs/onboarding/glossary.md) |
...
| [やさしい用語集](docs/onboarding/glossary.md) | spec / contract / cc:* マーカー / confidence % などを非エンジニア向けに説明。 |
...
| [Cursor Integration](docs/CURSOR_INTEGRATION.md) | Cursor handoff 境界と internal-compatible adapter メモ。 |
